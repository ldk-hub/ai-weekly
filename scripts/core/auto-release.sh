...
if gh release view "$TAG" --repo ldk-hub/ldk-hub.github.io >/dev/null 2>&1; then
...
out += '---\n\n';
out += '📊 [전체 보기](https://ldk-hub.github.io/) · 📡 [RSS](https://ldk-hub.github.io/feed.xml)\n';
...
gh release create "$TAG" \
  --repo ldk-hub/ldk-hub.github.io \
