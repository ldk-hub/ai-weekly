...
if gh release view "$TAG" --repo ldk-hub/aiweekly >/dev/null 2>&1; then
...
out += '---\n\n';
out += '📊 [전체 보기](https://ldk-hub.github.io/aiweekly/) · 📡 [RSS](https://ldk-hub.github.io/aiweekly/feed.xml)\n';
